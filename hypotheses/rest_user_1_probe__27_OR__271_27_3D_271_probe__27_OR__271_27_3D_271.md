...
- Generated: 2026-04-07T18:55:21.076115+00:00
...
```json
{
  ...
  "hypotheses": [
    {
      "confidence": 0.86,
      "hypothesis": "GET /rest/user/1?probe=%27+OR+%271%27%3D%271&probe=%27+OR+%271%27%3D%271 may return data across identity boundaries when identifiers are modified.",
      "mutations": [
        {
          "body": {},
    ...
    {
      "confidence": 0.57,
      "hypothesis": "GET /rest/user/1?probe=%27+OR+%271%27%3D%271&probe=%27+OR+%271%27%3D%271 may allow object discovery when nearby identifiers are requested.",
      "mutations": [
        {
          "body": {},
